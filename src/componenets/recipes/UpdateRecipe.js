                                ...
                                <Card id="NutriCollaps" >
                                    <CardBody style={{ background: "rgb(50 59 59)" }}>
                                        ...
                                        <FormGroup className="col-md-2 col-sm-3 col-xs-6 d-inline-block">
                                            ...
                                            <Input type="number" min="0" name="recipeCaloriesIn100Grams" defaultValue={recipeCaloriesIn100Grams} step="0.01" id="recipeCaloriesIn100Grams" onChange={(e) => setRecipeCaloriesIn100Grams(e.target.value)} />
                                        </FormGroup>
                                        <FormGroup className="col-md-2 col-sm-3 col-xs-6 d-inline-block">
                                            <Label for="recipeCarbohydIn100Grams">Glucides</Label>
                                            <Input type="number" min="0" name="recipeCarbohydIn100Grams" defaultValue={recipeCarbohydIn100Grams} step="0.01" id="recipeCarbohydIn100Grams" onChange={(e) => setRecipeCarbohydIn100Grams(e.target.value)} />
                                        </FormGroup>
                                        <FormGroup className="col-md-2 col-sm-3 col-xs-6 d-inline-block">
                                            <Label for="recipeProteinIn100Grams">Proteines</Label>
                                            <Input type="number" min="0" name="recipeProteinIn100Grams" defaultValue={recipeProteinIn100Grams} step="0.01" id="recipeProteinIn100Grams" onChange={(e) => setRecipeProteinIn100Grams(e.target.value)} />
                                        </FormGroup>
                                        <FormGroup className="col-md-2 col-sm-3 col-xs-6 d-inline-block">
                                            <Label for="recipeFatIn100Grams">Lipides</Label>
                                            <Input type="number" min="0" name="recipeFatIn100Grams" defaultValue={recipeFatIn100Grams} step="0.01" id="recipeFatIn100Grams" onChange={(e) => setRecipeFatIn100Grams(e.target.value)} />
                                        </FormGroup>
                                        <FormGroup className="col-md-2 col-sm-3 col-xs-6 d-inline-block">
                                            <Label for="recipeFiberIn100Grams">Fibres</Label>
                                            <Input type="number" min="0" name="recipeFiberIn100Grams" defaultValue={recipeFiberIn100Grams} step="0.01" id="recipeFiberIn100Grams" onChange={(e) => setRecipeFiberIn100Grams(e.target.value)} />
                                        </FormGroup>
